---
type: log
title: homeLab changelog — archive 2026
tags: [log, archive, changelog]
related: [index]
---

# HomeLab Project Changelog (Archive 2026)

Archived entries from `docs/changelog.md` (split 2026-09-18, target-driven: entries before 2026-07-02 moved here, newest first).
