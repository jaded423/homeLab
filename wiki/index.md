...
| Page | What |
|---|---|
| [[network-topology]] | Subnet 192.168.68.0/22, IP scheme, device table, Flint 3 router since 2026-09-23 (Archer retired, Deco = AP layer) + modem bridge mode, router history, 2.5G vmbr1, Feb-2026 migration. |
...
| [[dns-adblocking]] | pihole `.248` via the Flint's DHCP option 6, unbound infra-cache gotcha, the "ads returned?" gotcha, sdwan0 pin auto-remediation, bypass group. |
